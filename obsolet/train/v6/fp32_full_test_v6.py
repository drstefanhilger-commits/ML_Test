...
"""
FP32 FULL TEST V6
Testet ALLE Drohnen, die NICHT im Training waren.
Quelle: data/train_48k/drone_real_test/
...
TEST_DIR = Path("data/train_48k/drone_real_test")
...
def main():
    ...
    if not test_files:
        print("[ERR] Keine Test-Drohnen gefunden:", TEST_DIR)
        return
    ...
    print("\n======================================")
    print("        FP32 FULL TEST V6 SUMMARY")
    print("======================================")
    ...
    print("              STATISTIK")
    print("======================================")
    print(f"Anzahl Test-Drohnen:        {total}")
    print(f"Erkannte Drohnen:           {correct}")
    print(f"Nicht erkannte Drohnen:     {total - correct}")
    print(f"Erkennungsrate (Accuracy):  {accuracy:.3f}")
    print(f"Score Minimum:              {min(scores):.3f}")
    print(f"Score Maximum:              {max(scores):.3f}")
    print(f"Score Durchschnitt:         {np.mean(scores):.3f}")

    if wrong:
        print("\nFalsch erkannte Drohnen:")
        for name, score in wrong:
            print(f"  {name:40s} Score={score:.3f}")
    else:
        print("\nAlle Drohnen wurden korrekt erkannt!")

    print("======================================")
    print("        FP32 FULL TEST V6 DONE")
    print("======================================")
