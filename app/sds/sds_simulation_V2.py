...
SDS_NUM_MICS = 8
SDS_SAMPLE_RATE = 48000          # Modell-kompatibel
SDS_FRAME_LEN = 4096             # stabil für FFT/TODA
c = 343.0
...
def make_sds_drone_frame(angle_deg, distance_m, noise,
                         f0_hz=180.0,
                         harmonics=(2, 3, 4, 5),
                         save_wav_path=None):
    ...
    # WAV speichern (Mono-Mix oder Multi-Channel)
    if save_wav_path is not None:
        # Multi-channel WAV (8 Kanäle)
