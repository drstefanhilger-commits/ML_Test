...
"""
FP32 FULL TEST V7 — Pfad‑B, deterministisch

Testet das FP32‑Modell auf den echten Drohnen‑Testdaten:
...
# ---------------------------------------------------------
# Feature‑Extraktion (identisch zu build_features_v7.py)
# ---------------------------------------------------------
